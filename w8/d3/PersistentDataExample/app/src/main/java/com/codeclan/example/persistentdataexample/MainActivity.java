...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String returnedFromSharedPreferences = SavedTextPreferences.getStoredText(this);

        if (returnedFromSharedPreferences != null && !returnedFromSharedPreferences.isEmpty()){
            textToSave.setVisibility(View.INVISIBLE);
            saveButton.setVisibility(View.INVISIBLE);
            savedText.setText(returnedFromSharedPreferences);
