...
class PizzaOrder
  ...
  attr_accessor :first_name, :last_name, :topping, :quantity, :id
  ...
  def save()
    ...
    sql = "INSERT INTO pizza_orders (first_name, last_name, topping, quantity) VALUES ('#{@first_name}', '#{@last_name}', '#{@topping}', #{@quantity}) RETURNING *;"
